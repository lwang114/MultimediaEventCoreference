...
def get_all_candidate_from_topic(config, data, topic_num, docs_embeddings, docs_length, is_training=True, batch_idxs=None):
    ...
    for local_idx, i in enumerate(batch_idxs):
        doc_id = doc_names[i]
        ...
        doc_embeddings = docs_embeddings[local_idx][torch.tensor(range(docs_length[local_idx]))]  # remove padding
