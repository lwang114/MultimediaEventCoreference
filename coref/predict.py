...
if __name__ == '__main__':
    ...
    data = create_corpus(config, WordsField, config.split, is_training=False)
    ...
    for topic_num, topic in enumerate(data.topic_list):
        ...
        docs_embeddings, docs_length = pad_and_read_bert(data.topics_bert_tokens[topic_num], wase_model)
