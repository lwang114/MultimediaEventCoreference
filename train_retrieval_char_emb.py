...
from corpus_glove_char import GroundingGloveCharFeatureDataset
...
if __name__ == '__main__':
  ...
  if not config.get('glove_dimension', None):
    ...
    train_set = GroundingGloveCharFeatureDataset(os.path.join(config['data_folder'], 'train.json'), os.path.join(config['data_folder'], 'train_mixed.json'), config, split='train')
    test_set = GroundingGloveCharFeatureDataset(os.path.join(config['data_folder'], 'test.json'), os.path.join(config['data_folder'], 'test_mixed.json'), config, split='test')
  ...
  char_vec = np.load('data/char_vec.npy')
  text_model = CharCNN(char_vec, embedding_dim)
