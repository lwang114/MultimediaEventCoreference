...
class SRTester():
    ...
    def visualize_sets_triple(self, image_id_batch, y_verb, y_verb_, y, y_, verb_id2s, role_id2s, noun_id2s, sr_visualpath, image_path=None):
        ...
        if not image_path:
            image_path = '/ws/ifp-53_2/hasegawa/lwang114/fall2020/MultimediaEventCoreference/m2e2/data/imSitu/of500_images_resized/'
        if not os.path.isdir(os.path.join(sr_visualpath, 'verb_correct')):
            os.mkdir(os.path.join(sr_visualpath, 'verb_correct'))
        if not os.path.isdir(os.path.join(sr_visualpath, 'verb_wrong')):
            os.mkdir(os.path.join(sr_visualpath, 'verb_wrong'))
