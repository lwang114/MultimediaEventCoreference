    ...
    for i_batch, batch in enumerate(data_iter):
        ...
        running_loss, cnt, all_verbs, all_verbs_, all_role, all_role_, all_noun, all_noun_, all_triple, all_triple_, all_triple_group, all_triple_group_, image_id_batch = \
            run_over_batch_sr(batch, running_loss, cnt, all_verbs, all_verbs_, all_role, all_role_,
                            ...
                            train_ace=train_ace, load_object=load_object, visualize_path=visualize_path if i_batch % 200 == 0 else None)
        
        # TODO add_results(all_results, image_id_batch, all_verbs, all_verbs_, all_role, all_noun, all_role_, all_noun_, label_i2s, word_i2s, role_i2s)
